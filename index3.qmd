...
nocite: |
  @bez2025individuelle, @black1998, @beckmann1978, @timmerhaus2001
bibliography: references.bib
---

## Ziel des Vortrags {{< iconify fa-solid:bullseye >}}{.center}

> Ich möchte am **Beispiel »Formatives Assessment«** illustrieren, wie Fachdidaktiken und Bildungswissenschaften sich bei der Entwicklung von Professionalität durch Lehrpersonenbildung **gegenseitig bedingen**.
...
::: {.column width='60%'}
> Ich möchte am **Beispiel Formatives Assessment** illustrieren, wie Fachdidaktiken und Bildungswissenschaften die Entwicklung von Professionalität durch Lehrpersonenbildung **gleichermaßen bedingen**.
:::
...
::: {.column width='60%'}
<center>
![Hassediagramm nach Falmagne [-@falmagne1990]](img/hasse.png){width=60%}
</center>
:::
...
## <!-- Ausgewählte Projekte & Befunde--> {.smaller auto-animate="true"  .center}
::: {style="margin-top: 0px;font-size: 2.3em; font-weight: bold; color:#267326; margin-left: 0px;"}
...
#### Teilprojekt: **Aufgabendashboards** - Promotionskolleg [![](img/Logo_AQUAd.png){width=12% style="margin: -6px 0px!important;"}](img/Sunburst_AQUA.png){.lightbox}
...
![](img/lupe.png){fig-align="center" width="60%"}
...
::: footer
[**{{< iconify fa6-solid handshake >}}**]{style="size: 3em"}
:::
